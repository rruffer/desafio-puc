...
import br.com.valid.util.Arquivo;
import br.com.valid.util.Calculo;
import br.com.valid.util.Mensagem;
import br.com.valid.util.Tela;
...
/*		RequiredFieldValidator validator = new RequiredFieldValidator();
		txfUsuario.getValidators().add(validator);
		validator.setMessage("Usu�rio � obrigat�rio!");
		
		txfUsuario.focusedProperty().addListener(new ChangeListener<Boolean>() {
