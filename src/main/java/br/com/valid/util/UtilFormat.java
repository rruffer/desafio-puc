...
public class UtilFormat {
	...
	/**
	 * Método que <b><i>expande</i></b> um valor.
	 * @param valor - dado a ser expandido.
	 * @param tamanho - tamaho máximo que o valor deve expandir.
	 * @param expandirCom - dado que será concatenado ao valor para ser expandido.
